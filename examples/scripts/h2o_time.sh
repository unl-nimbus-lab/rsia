...
do
	...
	#empty compilation folder and then copy materials into it.
   	...
   	/usr/bin/time -v /home/nishant/ImpactAnalysis/Simulation/clangBuild.sh

   	/usr/bin/time -v /home/nishant/ImpactAnalysis/Simulation/clangCheck.sh
	...
	/usr/bin/time -v /home/nishant/ImpactAnalysis/phaseTwo/test/phaseTwo defaults
	
	echo "phase 2 completed: now remap"

	read -p "Press ENTER to continue" tempVar
